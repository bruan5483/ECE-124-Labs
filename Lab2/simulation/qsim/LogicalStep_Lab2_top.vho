...
SIGNAL \INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\ : std_logic;
SIGNAL \sw[3]~input_o\ : std_logic;
SIGNAL \sw[7]~input_o\ : std_logic;
SIGNAL \INST5|logic_out~1_combout\ : std_logic;
SIGNAL \INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\ : std_logic;
...
SIGNAL \INST3|DOUT[2]~3_combout\ : std_logic;
SIGNAL \INST1|Mux3~0_combout\ : std_logic;
SIGNAL \INST3|DOUT[3]~4_combout\ : std_logic;
SIGNAL \INST1|Mux2~0_combout\ : std_logic;
SIGNAL \INST3|DOUT[4]~5_combout\ : std_logic;
SIGNAL \INST3|ALT_INV_DOUT[4]~5_combout\ : std_logic;
SIGNAL \INST3|ALT_INV_DOUT[3]~4_combout\ : std_logic;
SIGNAL \INST3|ALT_INV_DOUT[0]~1_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\INST3|ALT_INV_DOUT[4]~5_combout\ <= NOT \INST3|DOUT[4]~5_combout\;
\INST3|ALT_INV_DOUT[3]~4_combout\ <= NOT \INST3|DOUT[3]~4_combout\;
\INST3|ALT_INV_DOUT[0]~1_combout\ <= NOT \INST3|DOUT[0]~1_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \INST3|ALT_INV_DOUT[0]~1_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \INST3|ALT_INV_DOUT[3]~4_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \INST3|ALT_INV_DOUT[4]~5_combout\,
	devoe => ww_devoe,
...
-- Equation(s):
-- \INST6|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\ = (\sw[1]~input_o\ & ((\sw[5]~input_o\) # ((\sw[4]~input_o\ & \sw[0]~input_o\)))) # (!\sw[1]~input_o\ & (\sw[4]~input_o\ & (\sw[0]~input_o\ & \sw[5]~input_o\)))
...
\INST6|INST3|FULL_ADDER_SUM_OUTPUT\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\ = \sw[2]~input_o\ $ (\sw[6]~input_o\ $ (\INST6|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\))
...
PORT MAP (
	dataa => \sw[2]~input_o\,
	datab => \sw[6]~input_o\,
	datac => \INST6|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\,
	combout => \INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\);
...
-- Equation(s):
-- \INST5|logic_out~1_combout\ = \sw[3]~input_o\ $ (\sw[7]~input_o\)
...
\INST6|INST4|FULL_ADDER_SUM_OUTPUT\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\ = \INST5|logic_out~1_combout\ $ (((\sw[2]~input_o\ & ((\sw[6]~input_o\) # (\INST6|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\))) # (!\sw[2]~input_o\ & (\sw[6]~input_o\ & 
-- \INST6|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\))))
...
PORT MAP (
	...
	combout => \INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\);

\INST1|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST1|Mux5~0_combout\ = (\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\ & ((\INST5|logic_out~0_combout\ & ((\INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\))) # (!\INST5|logic_out~0_combout\ & (\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\)))) # 
-- (!\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\ & (\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\ & (\INST5|logic_out~0_combout\ $ (\INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST5|logic_out~0_combout\,
	datab => \INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\,
	datac => \INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\,
	datad => \INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\,
...
-- Equation(s):
-- \INST6|INST3|FULL_ADDER_CARRY_OUTPUT~0_combout\ = (\sw[2]~input_o\ & ((\sw[6]~input_o\) # (\INST6|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\))) # (!\sw[2]~input_o\ & (\sw[6]~input_o\ & \INST6|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\))
...
-- Equation(s):
-- \INST3|DOUT[0]~0_combout\ = (!\INST3|clk_proc:COUNT[10]~q\ & ((\sw[3]~input_o\ & ((\sw[7]~input_o\) # (\INST6|INST3|FULL_ADDER_CARRY_OUTPUT~0_combout\))) # (!\sw[3]~input_o\ & (\sw[7]~input_o\ & \INST6|INST3|FULL_ADDER_CARRY_OUTPUT~0_combout\))))
...
PORT MAP (
	dataa => \sw[3]~input_o\,
	datab => \sw[7]~input_o\,
	datac => \INST6|INST3|FULL_ADDER_CARRY_OUTPUT~0_combout\,
	datad => \INST3|clk_proc:COUNT[10]~q\,
	combout => \INST3|DOUT[0]~0_combout\);

\INST1|Mux1~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST1|Mux1~0_combout\ = (\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\ & (!\INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\ & ((\INST5|logic_out~0_combout\) # (!\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\)))) # (!\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\ & 
-- ((\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\ & ((\INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\))) # (!\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\ & (\INST5|logic_out~0_combout\ & !\INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\))))
...
-- Equation(s):
-- \INST3|DOUT_TEMP[5]~1_combout\ = (!\INST3|DOUT[0]~0_combout\ & ((!\INST1|Mux1~0_combout\) # (!\INST3|clk_proc:COUNT[10]~q\)))
...
-- Equation(s):
-- \INST1|Mux0~0_combout\ = (\INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\) # ((\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\ & ((!\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\) # (!\INST5|logic_out~0_combout\))) # (!\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\ & 
-- ((\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\))))
...
-- Equation(s):
-- \INST1|Mux6~0_combout\ = (\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\ & (\INST5|logic_out~0_combout\ & (!\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\ & \INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\))) # (!\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\ & 
-- (\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\ $ (((\INST5|logic_out~0_combout\ & !\INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\)))))
...
-- Equation(s):
-- \INST3|DOUT[0]~1_combout\ = (\INST3|DOUT[0]~0_combout\) # ((\INST1|Mux6~0_combout\ & \INST3|clk_proc:COUNT[10]~q\))
...
-- Equation(s):
-- \INST1|Mux4~0_combout\ = (\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\ & (\INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\ & ((\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\) # (!\INST5|logic_out~0_combout\)))) # (!\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\ & 
-- (!\INST5|logic_out~0_combout\ & (\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\ & !\INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\)))
...
\INST3|DOUT[2]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST3|DOUT[2]~3_combout\ = (!\INST1|Mux4~0_combout\) # (!\INST3|clk_proc:COUNT[10]~q\)
...
PORT MAP (
	...
	combout => \INST3|DOUT[2]~3_combout\);

\INST1|Mux3~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST1|Mux3~0_combout\ = (\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\ & ((\INST5|logic_out~0_combout\ & (\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\)) # (!\INST5|logic_out~0_combout\ & (!\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\ & 
-- \INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\)))) # (!\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\ & (!\INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\ & (\INST5|logic_out~0_combout\ $ (\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\))))
...
\INST3|DOUT[3]~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST3|DOUT[3]~4_combout\ = (\INST3|DOUT[0]~0_combout\) # ((\INST3|clk_proc:COUNT[10]~q\ & \INST1|Mux3~0_combout\))
...
PORT MAP (
	...
	combout => \INST3|DOUT[3]~4_combout\);

\INST1|Mux2~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST1|Mux2~0_combout\ = (\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\ & (\INST5|logic_out~0_combout\ & ((!\INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\)))) # (!\INST6|INST2|FULL_ADDER_SUM_OUTPUT~combout\ & ((\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\ & 
-- ((!\INST6|INST4|FULL_ADDER_SUM_OUTPUT~combout\))) # (!\INST6|INST3|FULL_ADDER_SUM_OUTPUT~combout\ & (\INST5|logic_out~0_combout\))))
...
\INST3|DOUT[4]~5\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST3|DOUT[4]~5_combout\ = (\INST3|DOUT[0]~0_combout\) # ((\INST3|clk_proc:COUNT[10]~q\ & \INST1|Mux2~0_combout\))
...
PORT MAP (
	...
	combout => \INST3|DOUT[4]~5_combout\);
